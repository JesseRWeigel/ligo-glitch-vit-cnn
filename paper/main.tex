...
% O4
\newcommand{\vitMacroFOfour}{0.669} % REVISED: REF-006
...
\begin{enumerate}
  ...
  \item We report an honest negative result: the per-class pattern does not
    ...
    set size.
  \item We provide % REVISED: REF-005
...
\bibitem[Wu et~al.(2025)Wu et~al.]{Wu2024}  % REVISED: REF-013
Wu, Z. et~al., 2025,
